...
const Loading_1 = __importDefault(require("./Shared-Components/Loading"));
//Dynamic loading to separate the weight of the build bundle.
const ColourBox = (0, dynamic_1.default)(() => Promise.resolve().then(() => __importStar(require("./Shared-Components/ColourBox"))), { loading: () => react_1.default.createElement(Loading_1.default, null) });
function App() {
